...
function Input({ id, type = 'text', value, onChange, placeholder, required, min }) {
  return (
    <input
      id={id}
      type={type}
  ...
  return (
    <Dialog.Root open={open} onOpenChange={onOpenChange}>
      <Dialog.Portal>
        ...
        <Dialog.Content className="dialog-content fixed left-1/2 top-1/2 z-50 w-full max-w-md bg-zinc-900 border border-zinc-800 rounded-2xl shadow-2xl p-6">
          {/* Header */}
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-3 py-1">
              ...
              <SwitchRow
                ...
                checked={form.mute_notifs}
                onCheckedChange={(v) => set('mute_notifs', v)}
              />
            </div>
